        ...
        <div class="card-body">
                <div class="mt-3 d-sm-flex align-items-center justify-content-between border-bottom">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#product"
                                role="tab" aria-controls="overview" aria-selected="true">Product Queries</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="#contact" role="tab"
                                aria-selected="false">Contact Form Queries</a>
                        </li>
                    </ul>
                    <!-- <div>
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="product" role="tabpanel">
                        <h4 class="card-title card-title-dash mt-1 mb-2">Here's the list of all Product Queries</h4>
                        <div class="table-box">
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel">
                        <h4 class="card-title card-title-dash mt-1 mb-2">Here's the list of all queries from Contact
                            Form</h4>
                        <div class="table-box">
