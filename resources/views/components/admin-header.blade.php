      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        ...
        <ul class="navbar-nav ms-auto">
          <li class="nav-item dropdown d-none d-lg-block">
            <img src="images/light-logo.png" class="img-fluid" width="90%" height="auto"/>
          </li>
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              ...
              <form action="{{url('logout')}}" method="post">
                ...
                <button type="submit" class="border-0 bg-transparent w-100">
                    <a class="dropdown-item"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Sign Out</a></button>
              </form>
            </div>
          </li>
        </ul>
