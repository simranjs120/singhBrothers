...
class innerSectionController extends Controller
{
    ...
    public function submitSection(Request $request)
    {
        try {
            ...
            Log::error('Exception in submit inner section module: ' . $e->getMessage());
    ...
    public function editSection(Request $request)
    {
        try {
            ...
            Log::error('Exception in edit inner section module: ' . $e->getMessage());
            return redirect()->back()->with('error', 'Something went wrong!! Please try again !');
        }
    }
    ...
    public function editStatusSection($status, $id)
    {
        try {
            ...
            Log::error('Exception in inner section change status module: ' . $e->getMessage());
            return redirect()->back()->with('error', 'Something went wrong!! Please try again !');
        }
    }
    ...
    public function deleteSection($id)
    {
        try {
            ...
            Log::error('Exception in delete inner section module: ' . $e->getMessage());
            return redirect()->back()->with('error', 'Something went wrong!! Please try again !');
        }
    }
    ...
    public function assignInventory(Request $request)
    {
        try {
            ...
            Log::error('Exception in inner section assign inventory function: ' . $e->getMessage());
            return redirect()->back()->with('error', 'Something went wrong!! Please try again !');
        }
    }
}
