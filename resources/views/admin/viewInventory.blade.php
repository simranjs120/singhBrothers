...
<div class="container-fluid px-3">
    ...
    <div class="row mb-3">
        <div class="col-12">
            <h1 class="mb-1">View Inventory Item</h1>
            <p class="text-muted small mb-0 mt-3">Admin / Manage Inventory / View Inventory</p>
            <a href="{{url('admin/edit-inventory/' . $inventoryId)}}">
                <button type="button" class="btn btn-sm py-2 px-4 fw-bold rounded-3 background-secondary text-dark border border-dark text-decoration-none mt-4">Edit this item</button>
            </a>
        </div>
    </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <a href="javascript:history.back()"
                        class="mb-4 text-decoration-none text-dark d-inline-flex align-items-center gap-2 fw-semibold">
                        <i class="bi bi-arrow-left"></i>Back
                    </a>
                    <p class="fs-4">Inventory Details for <b>{{$inventory->itemName}}</b></p>
    ...
    <div class="row">
        <div class="card">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="">Offer badge: <span
                            class="badge badge-pill badge-danger">{{$inventory->offerBadge}}</span>
                    </h4>
                </div>
                <div class="col-lg-6">
