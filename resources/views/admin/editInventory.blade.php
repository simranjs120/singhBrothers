    ...
    <div class="card">
        <div class="col-sm-12">
            <div class="home-tab">
                ...
                @endif
                <form action="{{route('edit.inventory')}}" method="POST" enctype="multipart/form-data" id="inventory_form">
                    @csrf
                    <input type="hidden" name="id" value="{{$inventoryId}}"/>
                    <!-- Row 1 -->
                    <div class="row mb-4">
                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                            <label class="mt-3" style="background-color:red; color:white;">&nbsp;<b>Thumbnail Image</b></label><span class="asterik">*</span><br/>
                            <img src="{{Helper::props('admin/inventoryImages') . '/' . $inventoryData->thumbnailimg}}" id="thumbnailpreview" class="img-fluid mb-3 mt-3" height="40%" width="40%" alt="Upload Image for Preview"/>
                            <input type="file" name="thumbnailimg" id="thumbnailimg" class="form-control" @if($inventoryData->thumbnailimg=="") required @endif/>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                            <label class="mt-3">&nbsp;<b>Product Image 1</b></label><br/>
                            <img src="{{Helper::props('admin/inventoryImages') . '/' . $inventoryData->productimg1}}" id="productpreview1" class="img-fluid mb-3 mt-3" height="40%" width="40%" alt="Upload Image for Preview"/>
                            <input type="file" name="productimg1" id="productimg1" class="form-control" />
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                            <label class="mt-3">&nbsp;<b>Product Image 2</b></label><br/>
                            <img src="{{Helper::props('admin/inventoryImages') . '/' . $inventoryData->productimg2}}" id="productpreview2" class="img-fluid mb-3 mt-3" height="40%" width="40%" alt="Upload Image for Preview"/>
                            <input type="file" name="productimg2" id="productimg2" class="form-control" />
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                            <label class="mt-3">&nbsp;<b>Product Image 3</b></label><br/>
                            <img src="{{Helper::props('admin/inventoryImages') . '/' . $inventoryData->productimg3}}" id="productpreview3" class="img-fluid mb-3 mt-3" height="40%" width="40%" alt="Upload Image for Preview"/>
                    ...
                    <!-- Row 2 -->
                     <div class="row mb-4">
                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <input type="text" name="itemName" class="form-control" maxlength="180" required placeholder="Enter Item Name..." value="{{$inventoryData->itemName}}" required/>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                            <label class="mt-3">&nbsp;<b>Striker Price <s>₹1000</s></b></label>
                            <input type="text" name="strikerPrice" class="form-control" maxlength="80" placeholder="₹ Only Enter Number Here..." value="{{$inventoryData->strikerPrice}}"/>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                            <label class="mt-3">&nbsp;<b>Actual Price<span class="asterik">*</span></b></label>
                            <input type="text" name="actualPrice" class="form-control" maxlength="80" placeholder="₹ Only Enter Number Here..." value="{{$inventoryData->actualPrice}}" required/>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                            <label class="mt-3">&nbsp;<b>Any Offer Badge Text</b> <span class="badge badge-pill badge-danger">Diwali Special</span></label>
                            <input type="text" name="offerBadge" class="form-control" maxlength="180" placeholder="Enter any type of offer..." value="{{$inventoryData->offerBadge}}"/>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <input type="text" name="size" class="form-control" maxlength="80" placeholder="Enter like: 20 cm/20 Inches..." value="{{$inventoryData->size}}" required/>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                            <label class="mt-3">&nbsp;<b>Quantity<span class="asterik">*</span></b></label>
                            <input type="text" name="quantity" class="form-control" maxlength="80" placeholder="Enter only number here..." value="{{$inventoryData->quantity}}" required/>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                            <label class="mt-3">&nbsp;<b>Sale Pitch (Only Few Left,Hurry !!)</b></label>
                            <input type="text" name="salePitch" class="form-control" maxlength="180" placeholder="Something like: Only a few left !!" value="{{$inventoryData->salePitch}}"/>
                        </div>
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <label class="mt-3">&nbsp;<b>Any Important Notes</b></label>
                            <input type="text" name="importantNote" class="form-control" maxlength="500" placeholder="Any important note for customer..." value="{{$inventoryData->importantNote}}"/>
                        </div>
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
